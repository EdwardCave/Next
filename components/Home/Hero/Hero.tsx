  ...
  return (
    <div className='relative w-full h-[120vh] sm:h-[100vh]'>
        ...
        <div className='absolute z-[100] w-full h-full top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] '>
            <div className='flex justify-center items-center flex-col w-full h-full'>
                <div data-aos="fade-up">
                    <h1 className='text-[25px] mb-4 md:mb-0 text-center md:text-[35px] lg:text-[45px] tracking-[0.7rem] text-white font-bold uppercase'>
                        Lets Enjoy The Nature and future
                    </h1>
              ...
              className="rounded px-14 md:px-28 -mt-4 py-2.5 overflow-hidden group bg-rose-600 relative hover:bg-gradient-to-r
               hover:from-red-500 hover:to-red-400 text-white hover:ring-2 hover:ring-offset-2 hover:ring-red-400 transition-all 
            ...
            <span className='relative font-bold'>Search your Trip</span>
            </Link>
            </div>
